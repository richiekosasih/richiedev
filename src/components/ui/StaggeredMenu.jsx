...
export const StaggeredMenu = ({
  ...
  React.useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (openRef.current && menuWrapper && menuPanel && menuButton) {
  ...
  return (
    <div className='sm-scope w-full h-full' style={{ pointerEvents: 'auto' }}>
      <div
        className={
          (className ? className + ' ' : '') +
      ...
      >
        ...
        <header
          className='staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-end p-[2em] bg-transparent pointer-events-none z-[25]'
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        if (it.link.startsWith('#')) {
                          ...
                          // For page navigation, navigate to the route
                          e.preventDefault();
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className='sm-socials-item'>
                      <a
                        ...
                        className='sm-socials-link text-base font-medium text-[#111] no-underline relative inline-block py-1 px-2 transition-[color,opacity] duration-300 ease-linear hover:bg-gray-100 rounded'
                        style={{
                          '--social-hover-color': s.hoverColor || '#ff6b6b',
                        }}
                        onMouseEnter={(e) => {
...
.sm-scope .sm-socials-link:hover { color: var(--social-hover-color, var(--sm-accent, #ff0000)); }
...
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; min-height: 100vh; padding-bottom: 3rem; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); } .sm-scope .sm-panel-item { font-size: 2.5rem; line-height: 1.1; padding-right: 2.5em; } .sm-scope .sm-panel-list { gap: 0.25rem; } .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { right: 0.5em; font-size: 14px; top: 0.2em; } .sm-scope .sm-socials { margin-top: 1.5rem; padding-top: 1rem; flex-shrink: 0; } .sm-scope .sm-socials-link { font-size: 0.9rem; } }
      `}</style>
    </div>
  );
};
